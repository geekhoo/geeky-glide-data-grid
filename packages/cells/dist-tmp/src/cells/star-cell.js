...
const renderer = {
    ...
    provideEditor: () => {
        ...
        return p => (_jsx(EditorWrap, { children: [0, 1, 2, 3, 4].map(index => (_jsx("div", { className: p.value.data.rating < index + 1 ? "gdg-inactive" : "gdg-active", onClick: () => {
                    p.onChange({
                        ...p.value,
                        data: {
                            ...p.value.data,
