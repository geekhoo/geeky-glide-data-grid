...
function prep(resetTimers = true) {
...
a new line char ""more quotes"" plus a tab  ."	https://google.com`)),
    ...
    test("Select range - single-cell", async () => {
        const spy = vi.fn();
        vi.useFakeTimers();
        render(_jsx(EventedDataEditor, { ...basicProps, rangeSelect: "cell", onGridSelectionChange: spy }), {
            wrapper: Context,
        });
        prep();
    ...
    test("Select range - single-cell with row/column blending", async () => {
        ...
        render(_jsx(EventedDataEditor, { ...basicProps, gridSelection: {
            ...
            }, rangeSelect: "cell", rowSelectionBlending: "mixed", rangeSelectionBlending: "mixed", columnSelectionBlending: "mixed", onGridSelectionChange: spy }), {
            wrapper: Context,
        });
        prep();
        const canvas = screen.getByTestId("data-grid-canvas");
    ...
    test("Select row - single-cell with row blending", async () => {
        ...
        render(_jsx(EventedDataEditor, { ...basicProps, gridSelection: {
            ...
            }, rangeSelect: "cell", rowSelectionBlending: "mixed", rangeSelectionBlending: "mixed", onGridSelectionChange: spy }), {
            wrapper: Context,
        });
        prep();
        const canvas = screen.getByTestId("data-grid-canvas");
    ...
    test("Select row - single-cell/single-row with row blending", async () => {
        ...
        render(_jsx(EventedDataEditor, { ...basicProps, gridSelection: {
                ...
                columns: CompactSelection.empty(),
                rows: CompactSelection.empty(),
            }, rangeSelect: "cell", rowSelect: "single", rowSelectionBlending: "mixed", rangeSelectionBlending: "mixed", onGridSelectionChange: spy }), {
            wrapper: Context,
        });
        prep();
        const canvas = screen.getByTestId("data-grid-canvas");
    ...
    test("Select col - single-cell with col blending", async () => {
        ...
        render(_jsx(EventedDataEditor, { ...basicProps, gridSelection: {
                ...
                columns: CompactSelection.empty(),
                rows: CompactSelection.empty(),
            }, rangeSelect: "cell", columnSelectionBlending: "mixed", rangeSelectionBlending: "mixed", onGridSelectionChange: spy }), {
            wrapper: Context,
        });
        prep();
        const canvas = screen.getByTestId("data-grid-canvas");
    ...
    test("Select col - single-cell/single-col with col blending", async () => {
        ...
        render(_jsx(EventedDataEditor, { ...basicProps, gridSelection: {
                ...
                columns: CompactSelection.empty(),
                rows: CompactSelection.empty(),
            }, rangeSelect: "cell", columnSelect: "single", columnSelectionBlending: "mixed", rangeSelectionBlending: "mixed", onGridSelectionChange: spy }), {
            wrapper: Context,
        });
        prep();
        const canvas = screen.getByTestId("data-grid-canvas");
