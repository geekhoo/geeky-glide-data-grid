...
const renderer = {
    ...
    provideEditor: () => {
        ...
        return p => {
            ...
            return (_jsx(EditorWrap, { tagHeight: tagHeight, innerPad: innerPad, className: readonly ? "gdg-readonly" : "", children: possibleTags.map(t => {
                    const selected = tags.indexOf(t.tag) !== -1;
                    return (_jsxs("label", { children: [!readonly && (_jsx("input", { className: "gdg-input", type: "checkbox", checked: selected, onChange: () => {
                                ...
                                } })), _jsx("div", { className: "gdg-pill " + (selected ? "gdg-selected" : "gdg-unselected"), style: { backgroundColor: selected ? t.color : undefined }, children: t.tag })] }, t.tag));
                }) }));
        };
    },
    onPaste: (v, d) => ({
