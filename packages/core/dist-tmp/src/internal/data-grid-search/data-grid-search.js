...
// icons
const upArrow = (_jsx("svg", { className: "button-icon", viewBox: "0 0 512 512", children: _jsx("path", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "48", d: "M112 244l144-144 144 144M256 120v292" }) }));
const downArrow = (_jsx("svg", { className: "button-icon", viewBox: "0 0 512 512", children: _jsx("path", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "48", d: "M112 268l144 144 144-144M256 392V100" }) }));
const closeX = (_jsx("svg", { className: "button-icon", viewBox: "0 0 512 512", children: _jsx("path", { fill: "none", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "32", d: "M368 368L144 144M368 144L144 368" }) }));
...
const DataGridSearch = p => {
    ...
    const searchbox = React.useMemo(() => {
        ...
        return (_jsxs(SearchWrapper, { className: showSearch ? "" : "out", onMouseDown: cancelEvent, onMouseMove: cancelEvent, onMouseUp: cancelEvent, onClick: cancelEvent, children: [_jsxs("div", { className: "gdg-search-bar-inner", children: [_jsx("input", { id: searchID, "aria-hidden": !showSearch, "data-testid": "search-input", ref: searchInputRef, onChange: onSearchChange, value: searchString, tabIndex: showSearch ? undefined : -1, onKeyDownCapture: onSearchKeyDown }), _jsx("button", { "aria-label": "Previous Result", "aria-hidden": !showSearch, tabIndex: showSearch ? undefined : -1, onClick: onPrev, disabled: (searchStatus?.results ?? 0) === 0, children: upArrow }), _jsx("button", { "aria-label": "Next Result", "aria-hidden": !showSearch, tabIndex: showSearch ? undefined : -1, onClick: onNext, disabled: (searchStatus?.results ?? 0) === 0, children: downArrow }), onSearchClose !== undefined && (_jsx("button", { "aria-label": "Close Search", "aria-hidden": !showSearch, "data-testid": "search-close-button", tabIndex: showSearch ? undefined : -1, onClick: onClose, children: closeX }))] }), searchStatus !== undefined ? (_jsxs(_Fragment, { children: [_jsx("div", { className: "gdg-search-status", children: _jsx("div", { "data-testid": "search-result-area", children: resultString }) }), _jsx("div", { className: "gdg-search-progress", style: progressStyle })] })) : (_jsx("div", { className: "gdg-search-status", children: _jsx("label", { htmlFor: searchID, children: "Type to search" }) }))] }));
    }, [
        showSearch,
        isAnimatingOut,
        searchStatus,
