...
const DataGridOverlayEditor = p => {
    ...
    return createPortal(_jsx(ThemeContext.Provider, { value: theme, children: _jsx(ClickOutsideContainer, { style: makeCSSStyle(theme), className: className, onClickOutside: onClickOutside, isOutsideClick: isOutsideClick, children: _jsx(DataGridOverlayEditorStyle, { ref: ref, id: id, className: classWrap, style: styleOverride, as: useLabel === true ? "label" : undefined, targetX: target.x - bloomX, targetY: target.y - bloomY, targetWidth: target.width + bloomX * 2, targetHeight: target.height + bloomY * 2, children: _jsx("div", { className: "gdg-clip-region", onKeyDown: onKeyDown, children: editor }) }) }) }), portalElement);
};
