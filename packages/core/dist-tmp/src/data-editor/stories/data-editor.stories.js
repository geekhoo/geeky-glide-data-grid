...
export function Simplenotest() {
    ...
    return (_jsx(DataEditor, { width: "100%", getCellContent: getDummyData, getCellsForSelection: true, columns: cols, rows: 1000, onColumnResize: onColumnResize }));
}
...
function getDummyRelationData([col, row]) {
    return {
        kind: GridCellKind.Drilldown,
        data: [
            {
...
export function RelationColumn() {
    ...
    return (_jsx(DataEditor, { width: "100%", getCellContent: getDummyRelationData, columns: cols, rows: 1000, onColumnResize: onColumnResize, smoothScrollX: true, smoothScrollY: true }));
}
const columns = [
...
export function Minimal() {
    return _jsx(DataEditor, { width: "100%", getCellContent: getData, columns: columns, rows: 1000 });
}
export function Smooth() {
    ...
    return (_jsx(DataEditor, { width: "100%", getCellContent: getDummyData, onColumnResize: onColumnResize, columns: cols, rows: 1000, smoothScrollY: true, smoothScrollX: true }));
}
export function ManualControl() {
    ...
    return (_jsx(DataEditor, { width: "100%", gridSelection: gridSelection, onGridSelectionChange: cb, getCellContent: getData, columns: columns, rows: 1000 }));
}
export function Draggable() {
    return (_jsx(DataEditor, { width: "100%", isDraggable: true, onDragStart: args => {
...
export function IdealSize() {
    ...
    return (_jsx("div", { style: { width: 500, height: 500, position: "relative" }, children: _jsx(DataEditor, { width: 500, height: 500, isDraggable: true, onDragStart: args => {
                args.setData("text", "testing");
            }, getCellContent: getData, columns: cols, smoothScrollX: true, smoothScrollY: true, rowHeight: 50, headerHeight: 50, rows: 9 }) }));
}
export function DynamicAddRemoveColumns({ columnCount }) {
    // trying to be 500x500
    const cols = [
        { title: "Number", width: 250 },
        { title: "Square", width: 250 },
    ...
    return (_jsx(DataEditor, { width: "100%", isDraggable: true, getCellContent: getData, columns: cols, smoothScrollX: true, smoothScrollY: true, rowHeight: 50, headerHeight: 50, rows: 9 }));
}
DynamicAddRemoveColumns.args = {
    columnCount: 2,
};
export function GridSelectionOutOfRangeNoColumns() {
    const dummyCols = useMemo(() => getDummyCols().map(v => ({ ...v, width: 300, title: "Making column smaller used to crash!" })), []);
    ...
    const onSelected = useCallback((newSel) => {
        setSelected(newSel);
    }, []);
    return (_jsx(DataEditor, { width: "100%", getCellContent: getDummyData, columns: cols, rows: 1000, onGridSelectionChange: onSelected, gridSelection: selected, onColumnResize: (_col, newSize) => {
            if (newSize > 300) {
                setCols(dummyCols);
            }
            else {
...
export function ResizableColumns() {
    ...
    return (_jsx(DataEditor, { width: "100%", getCellContent: getDummyData, columns: cols, rows: 20, isDraggable: false, smoothScrollX: true, smoothScrollY: true, onColumnResize: onColumnResize }));
}
...
export function GridAddNewRows() {
    ...
    return (_jsx(DataEditor, { width: "100%", getCellContent: getDummyData, columns: cols, rows: rowsCount, onRowAppended: onRowAppended, onGridSelectionChange: onSelected, gridSelection: selected }));
}
export function GridNoTrailingBlankRow() {
    ...
    return (_jsx(DataEditor, { width: "100%", getCellContent: getDummyData, columns: cols, rows: 100, onGridSelectionChange: onSelected, gridSelection: selected }));
}
export function MarkdownEdits() {
    ...
    const dummyCells = useCallback(([col, _row]) => {
        if (col === 0) {
            const editable = {
                data: "text",
                allowOverlay: true,
...
- preview
    ...
    return (_jsx(DataEditor, { width: "100%", getCellContent: dummyCells, columns: dummyCols, rows: 1000, onGridSelectionChange: onSelected, gridSelection: selected }));
}
export const CanEditBoolean = () => {
    const [vals, setVals] = useState([false, false]);
    return (_jsx(DataEditor, { width: "100%", columns: [
            {
                title: "Editable",
                width: 100,
            },
