...
const renderer = {
    ...
    provideEditor: () => p => {
        ...
        return (_jsxs(LinksCellEditorStyle, { onKeyDown: ignoreTab, children: [links.map((l, i) => (_jsx(LinkTitleEditor, { link: l.href ?? "", title: l.title, focus: i === 0, onDelete: links.length > 1
                        ? () => {
                    ...
                    } }, i))), _jsx("button", { disabled: links.length >= maxLinks, className: "add-link", onClick: () => {
    ...
    onPaste: (v, d) => {
        const split = v.split(",");
        if (d.links.some((l, i) => split[i] !== l.title))
            return undefined;
        return {
            ...d,
...
const LinkTitleEditor = p => {
    ...
    return (_jsxs("div", { className: "gdg-link-title-editor", children: [_jsx("input", { className: "gdg-title-input", value: title, placeholder: "Title", autoFocus: focus, onChange: e => {
                    onChange(link, e.target.value);
                } }), _jsx("input", { className: "gdg-link-input", value: link, placeholder: "URL", onChange: e => {
                    onChange(e.target.value, title);
                } }), onDelete !== undefined && (_jsx("button", { onClick: onDelete, children: _jsxs("svg", { width: 16, height: 16, viewBox: "0 0 24 24", fill: "none", id: "icon-import", xmlns: "http://www.w3.org/2000/svg", children: [_jsx("path", { d: "M3 6L5 6L21 6", stroke: "currentColor", strokeWidth: "1px", strokeLinecap: "round", strokeLinejoin: "round" }), _jsx("path", { d: "M17.9019 6C18.491 6 18.9525 6.50676 18.8975 7.09334L17.67 20.1867C17.5736 21.2144 16.711 22 15.6787 22H8.32127C7.28902 22 6.42635 21.2144 6.33 20.1867L5.1025 7.09334C5.04751 6.50676 5.50898 6 6.09813 6H17.9019Z", stroke: "currentColor", strokeWidth: "1px", strokeLinecap: "round", strokeLinejoin: "round" }), _jsx("path", { d: "M14.4499 10.211L13.9949 17", stroke: "currentColor", strokeWidth: "1px", strokeLinecap: "round", strokeLinejoin: "round" }), _jsx("path", { d: "M9.55499 10.211L10.0049 17", stroke: "currentColor", strokeWidth: "1px", strokeLinecap: "round", strokeLinejoin: "round" }), _jsx("path", { d: "M7.5 2.25H16.5", stroke: "currentColor", strokeWidth: "1px", strokeLinecap: "round", strokeLinejoin: "round" })] }) }))] }));
};
