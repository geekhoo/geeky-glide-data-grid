...
export const InfiniteScroller = p => {
    ...
    let key = 0;
    let h = 0;
    padders.push(_jsx("div", { style: { width: scrollWidth, height: 0 } }, key++));
    while (h < scrollHeight) {
        const toAdd = Math.min(5_000_000, scrollHeight - h);
        padders.push(_jsx("div", { style: { width: 0, height: toAdd } }, key++));
        h += toAdd;
    }
    ...
    return (_jsx("div", { ref: ref, children: _jsxs(ScrollRegionStyle, { isSafari: browserIsSafari.value, children: [_jsx("div", { className: "dvn-underlay", children: children }), _jsx("div", { ref: setRefs, style: lastProps.current, draggable: draggable, onDragStart: e => {
                        if (!draggable) {
                            e.stopPropagation();
                            e.preventDefault();
                        }
                    }, className: "dvn-scroller " + (className ?? ""), onScroll: () => onScroll(), children: _jsxs("div", { className: "dvn-scroll-inner" + (rightElement === undefined ? " dvn-hidden" : ""), children: [_jsx("div", { className: "dvn-stack", children: padders }), rightElement !== undefined && (_jsxs(_Fragment, { children: [!rightElementFill && _jsx("div", { className: "dvn-spacer" }), _jsx("div", { ref: rightWrapRef, style: {
                                            height,
