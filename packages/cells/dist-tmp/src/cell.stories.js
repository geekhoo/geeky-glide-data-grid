...
const BeautifulWrapper = p => {
    ...
    return (_jsxs(BeautifulStyle, { children: [_jsx("h1", { children: title }), description, _jsx("div", { className: "sizer", children: _jsx("div", { className: "sizer-clip", ref: ref, children: _jsx("div", { style: {
                            position: "relative",
                            width: width ?? 100,
                            height: height ?? 100,
                        }, children: children }) }) })] }));
...
export const CustomCells = () => {
    return (_jsx(BeautifulWrapper, { title: "Custom cells", description: _jsx(Description, { children: "Some of our extension cells." }), children: _jsx(DataEditor, { ...defaultProps, customRenderers: allCells, onPaste: true, 
...
export const CustomCellEditing = () => {
    ...
    return (_jsx(BeautifulWrapper, { title: "Custom cell editing", description: _jsx(Description, { children: "Cells can be edited and responding to copy/paste using the copyData attribute." }), children: _jsx(DataEditor, { ...defaultProps, customRenderers: allCells, onPaste: true, fillHandle: true, onCellEdited: (cell, newVal) => {
                const [col, row] = cell;
