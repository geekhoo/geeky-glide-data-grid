...
export const GrowingEntry = (props) => {
    ...
    return (_jsxs(GrowingEntryStyle, { className: "gdg-growing-entry", children: [_jsx(ShadowBox, { className: className, children: useText + "\n" }), _jsx(InputBox, { ...rest, className: (className ?? "") + " gdg-input", id: inputID, ref: inputRef, onKeyDown: onKeyDownInner, value: useText, placeholder: placeholder, dir: "auto" })] }));
};
