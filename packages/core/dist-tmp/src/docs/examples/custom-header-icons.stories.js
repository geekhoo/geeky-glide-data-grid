...
export default {
    ...
    decorators: [
        (Story) => (_jsx(SimpleThemeWrapper, { children: _jsx(BeautifulWrapper, { title: "Custom header icons", description: _jsx(_Fragment, { children: _jsxs(Description, { children: ["You can provide overrides for the default icons by passing the", " ", _jsx(PropName, { children: "headerIcons" }), " prop."] }) }), children: _jsx(Story, {}) }) })),
    ],
};
export const CustomHeaderIcons = () => {
    ...
    return (_jsx(DataEditor, { ...defaultProps, getCellContent: getCellContent, columns: realCols, onCellEdited: setCellValue, onColumnResize: onColumnResize, headerIcons: headerIcons, rows: 1000 }));
};
