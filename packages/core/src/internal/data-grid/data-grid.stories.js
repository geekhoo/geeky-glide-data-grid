...
export default {
    ...
    decorators: [
        (Story) => (_jsx("div", { children: _jsx(BuilderThemeWrapper, { width: 1800, height: 1000, children: _jsx("div", { style: { position: "relative" }, children: _jsx(Story, {}) }) }) })),
    ],
};
