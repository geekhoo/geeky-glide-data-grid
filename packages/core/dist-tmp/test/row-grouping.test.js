...
import { expandRowGroups, flattenRowGroups, useRowGroupingInner, } from "../src/data-editor/row-grouping.js";
...
describe("useRowGroupingInner - getRowThemeOverride", () => {
    ...
    it("returns correct theme for non-group-header rows according to getRowThemeOverrideIn", () => {
        ...
        const getRowThemeOverrideIn = (row) => ({ bgCell: row % 2 === 0 ? "blue" : "green" });
