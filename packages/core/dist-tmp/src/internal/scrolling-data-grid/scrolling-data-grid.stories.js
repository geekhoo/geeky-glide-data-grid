...
import { CompactSelection, GridCellKind, } from "../data-grid/data-grid-types.js";
...
export default {
    ...
    decorators: [
        (Story) => (_jsx("div", { children: _jsx(BuilderThemeWrapper, { width: 1500, height: 1000, children: _jsx(InnerContainer, { children: _jsx(Story, {}) }) }) })),
    ],
};
