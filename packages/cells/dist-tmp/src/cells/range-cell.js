...
const renderer = {
    ...
    provideEditor: () => {
        ...
        return p => {
            ...
            return (_jsxs("label", { style: wrapperStyle, children: [_jsx("input", { style: inputStyle, type: "range", value: strValue, min: strMin, max: strMax, step: strStep, onChange: onChange, disabled: readonly }), strValue] }));
        };
    },
    onPaste: (v, d) => {
