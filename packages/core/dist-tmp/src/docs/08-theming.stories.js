...
export const Theming = () => {
    ...
    const getContentThemed = React.useCallback((cell) => {
        const [col, row] = cell;
        const dataRow = data[row];
        const indexes = ["name", "company", "email", "phone"];
        const d = dataRow[indexes[col]];
...
` }), _jsx(Highlight, { children: `
return <DataEditor 
        theme={{
          bgCell: "#F2F9FF"
        }} 
        getCellContent={getContent} columns={columns} rows={data.length} />
` }), _jsx(Wrapper, { height: 200, children: _jsx(DataEditor, { theme: {
                        bgCell: "#F2F9FF",
                    }, getCellContent: getContent, columns: columns, rows: data.length }) }), _jsx(Marked, { children: `### Column themes
Themes can be applied at the column level as well by setting the \`themeOverride\` on the \`GridColumn\`.` }), _jsx(Highlight, { children: `
...
` }), _jsx(Wrapper, { height: 200, children: _jsx(DataEditor, { theme: {
                        bgCell: "#F2F9FF",
                    }, getCellContent: getContent, columns: themeColumns, rows: data.length }) }), _jsx(Marked, { children: `### Row themes` }), _jsx(Highlight, { children: `
...
` }), _jsx(Wrapper, { height: 200, children: _jsx(DataEditor, { theme: {
                        bgCell: "#F2F9FF",
                    }, getRowThemeOverride: getRowThemeOverride, getCellContent: getContent, columns: themeColumns, rows: data.length }) }), _jsx(Marked, { children: `### Cell themes` }), _jsx(Highlight, { children: `
